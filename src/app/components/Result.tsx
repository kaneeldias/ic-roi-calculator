...
export default function Result(props: Props) {
    ...
    return (
        <div className={`flex flex-col h-full bg-black bg-opacity-5 rounded-md p-5 border-dashed border-2 border-gray-800 border-opacity-25 justify-center`}>
            <div>
                You need to do
            </div>
            <div className={`flex flex-row font-bold space-x-3 items-center`}>
                <div className={`text-8xl`}>{Math.ceil(numApprovals)}</div>
                <div className={`text-4xl`}>approvals</div>
            </div>
            ...
            <div className={`flex flex-col mt-10 text-sm font-mono`}>
